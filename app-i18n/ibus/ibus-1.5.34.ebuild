...
inherit autotools bash-completion-r1 gnome3 python-r1 toolchain-funcs vala

DESCRIPTION="Intelligent Input Bus for Linux/Unix"
HOMEPAGE="https://github.com/ibus/ibus/wiki"
SRC_URI="https://api.github.com/repos/ibus/ibus/tarball/1.5.34 -> ibus-1.5.34-1f7af28.tar.gz"
LICENSE="LGPL-2.1"
SLOT="0"
KEYWORDS="*"
IUSE="X appindicator +emoji gtk2 +gtk3 +gtk4 +gui +introspection
libnotify nls +python +unicode +vala wayland
"
